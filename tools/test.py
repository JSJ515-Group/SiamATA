...
parser.add_argument('--snapshot', type=str, default='./snapshot/checkpoint_e16.pth',
                    help='snapshot of models to eval')
parser.add_argument('--config', type=str, default='../experiments/resnet50_all/config.yaml',
                    help='config file')
