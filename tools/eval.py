...
parser.add_argument('--dataset_dir', type=str, default='/home/yxy/xyz/testing_dataset',
                    help='dataset root directory')
parser.add_argument('--dataset', type=str, default='UAV123',
                    help='dataset name')
parser.add_argument('--tracker_result_dir', type=str, default='./results', help='tracker result root')
...
def main():
    ...
    if 'OTB' in args.dataset:
        ...
        benchmark.show_result(auc_ret, show_video_level=args.show_video_level)
